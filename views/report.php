    ...
    <div class="card" style="border-top: 4px solid #2563eb;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 1px solid #e2e8f0; padding-bottom: 1rem; margin-bottom: 1.5rem;">
            <div>
                ...
                <p style="font-size: 0.85rem; color: #64748b;">Puesto: <?= htmlspecialchars($candidateData['position_applied']) ?></p>
            </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 2rem;">
            <div style="background: #f8fafc; padding: 1rem; border-radius: 6px; text-align: center;">
                <span style="font-size: 0.85rem; color: #64748b; font-weight: 600;">EVALUACIÓN TÉCNICA</span>
                <p style="font-size: 1.8rem; font-weight: 700; color: #2563eb; margin-top: 0.2rem;"><?= $candidateData['technical_score'] ?> / 10</p>
            </div>
            <div style="background: #f8fafc; padding: 1rem; border-radius: 6px; text-align: center;">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <p style="background: #f1f5f9; padding: 1rem; border-radius: 6px; color: #334155; line-height: 1.5;">
